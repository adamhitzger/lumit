              ...
              <div className="relative max-w-xl h-[300px] mx-auto lg:h-[420px]">
                ...
                <div className="absolute inset-0 flex rounded-xl flex-col justify-center items-center p-4 py-7 z-10 bg-black/40">
                  <span className="mb-5 text-3xl font-bold text-white drop-shadow-lg">
                   ...
                   {c.discount&& c.discount > 0 ?  <p className="space-x-2 mb-3"><span className="line-through font-bold text-red-400  text-xl">{c.nPrice.toLocaleString("cs-CZ")} Kč</span> <span className="font-bold text-white text-xl">{(c.nPrice-(c.discount)).toLocaleString("cs-CZ")} Kč</span></p> : null}
